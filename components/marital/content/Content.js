...
const Content = ({ data, pb }) => {
  return (
    <section className={`w-full pt-[40px] md:pt-[70px] pb-[30px] md:pb-[50px] bg-[#fff] relativ e ${pb ? "pb-[300px]" : ""}`}>
      ...
      <div className="myContainer flex flex-col lg:flex-row justify-end relative pt-[3.7%] pb-[8%]">
        ...
        <div className='absolute left-0 top-[5%] xl:top-[unset] max-w-[90%]  lg:max-w-[90%] xl:max-w-[45%]'>
          <div className='max-w-[100%] left-0 after:w-[150px] md:after:w-[337px] relative after:h-[100px] md:after:h-[200px] after:bg-[#0F2E3C] after:rounded-bl-[100px] after:right-[50px] after:bottom-[-25px] after:absolute after:z-[-1] z-[2]
   ...
   <div className="w-full xl:w-[50%] pt-[92%] sm:pt-[86%] md:pt-[680px] xl:pt-0">
          ...
          <ul className='fle x flex-wra p list-disc'>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0"> There is little to no communication between you and your spouse </li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0">You’ve become indifferent to each other </li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0">You and/or your spouse withhold affection </li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0">There are constant misunderstandings between you and your spouse </li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0">Any communication leads to arguments and negativity </li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0">You keep secrets from one another and lie </li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0">Either one of you is unfaithful, whether physically or emotionally </li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0">You’re having the same arguments over and over </li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0">You’re living separate lives</li>
          </ul>
        </div>
      </div>
    </section>
