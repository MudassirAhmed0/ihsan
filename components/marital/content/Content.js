      ...
      <div className="myContainer flex flex-col xl:flex-row justify-end relative pt-[3.7%] pb-[8%]">
        ...
        <div className="w-full xl:w-[50%] pt-[97%] md:pt-[680px] xl:pt-0">
          ...
          <ul className='fle x flex-wra p list-disc'>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0"> There is little to no communication between you and your spouse </li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0">You’ve become indifferent to each other </li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0">You and/or your spouse withhold affection </li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0">There are constant misunderstandings between you and your spouse </li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0">Any communication leads to arguments and negativity </li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0">You keep secrets from one another and lie </li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0">Either one of you is unfaithful, whether physically or emotionally </li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0">You’re having the same arguments over and over </li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0">You’re living separate lives</li>
          </ul>
        </div>
      </div>
    </section>
