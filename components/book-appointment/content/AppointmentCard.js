    ...
    <div className="flex flex-col-reverse lg:flex-row  ">
      ...
      <div className="w-full pl-0 lg:pl-[30px] mb-[30px] lg:mb-0">
        ...
        <div className="w-full  mt-[25px]">
          ...
          <li class="fgr font-[600] relative top-[-50px] float-right text-[#fff] transition-all duration-300 text-[12px] md:text-[16px] py-[15px] xl:py-[30px]"><a class="bg-[#AE8B5C] text-[#fff] rounded-[50px] px-[25px] py-[10px] hover:opacity-[.8]" href="https://calendly.com/farhan-ahmed/couples-session?month=2022-09" target={'_blank'}>Schedule Now</a></li>
        </div>
      </div>
    </div>
  );
