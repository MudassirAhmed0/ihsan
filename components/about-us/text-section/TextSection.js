      ...
      <div className='myContainer'>
        ...
        <div className='flex flex-col md:flex-row flex-wrap justify-between gap-y-[21px] md:gap-y-[80px] lg:gap-y-[100px] gap-x-0 md:gap-x-[3%]'>
          ...
          <div className='w-full md:w-[48%]'>
            ...
            <p className="fgr text-[#555555] text-[12px] md:text-[16px] leading-[15px] md:leading-[26px]">Asking for help is a brave first step. Every session is a judgment-free, safe space where you can comfortably speak to us about anything.</p>
          </div>
          <div className='w-full md:w-[48%]'>
            <h6 className='fgb text-[#555555] text-[12px] md:text-[28px] leading-[16px] md:leading-[30px] pb-[5px]'>Personalized</h6>
            <p className="fgr text-[#555555] text-[12px] md:text-[16px] leading-[15px] md:leading-[26px]">No two people or circumstances are alike, and neither are the solutions we offer. Every coaching program we put together is tailored to each individual’s or couple’s needs, challenges or goals.</p>
          </div>
