  ...
  return (
    ...
    <section className="w-full pt-[40px] pb-[50px] md:py-[93px] bg-[#F2F2F2] relative overflow-hidden">
      ...
      <div className="myContainer flex flex-col-reverse lg:flex-row relative z-[1]">
        ...
        <div className='home-hero-img w-[46%] mt-[-30px] right-0 md:right-[-20px] before:w-[58px] md:before:w-[200px] relative before:h-[58px] md:before:h-[200px] before:bg-[#AE8B5C] before:rounded-[100px] before:right-[0] md:before:right-[-35px] before:bottom-0 md:before:bottom-[10px] before:absolute'>
          <Image src={heroimg} />
        </div>
      </div>
    </section>
