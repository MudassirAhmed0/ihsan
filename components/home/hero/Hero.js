...
const Hero = () => {
  return (
    <>
      ...
      <section className="w-full pt-[40px] pb-[30px] md:py-[50px] bg-[#F2F2F2] relative overflow-hidden">
        ...
        <div className="myContainer flex flex-col-reverse lg:flex-row relative z-[1]">
          <div className="w-full lg:w-[48%] pt-[3%]">
            <h1 className="fpr text-[35px] sm:text-[70px] md:text-[110px]   leading-[35px]  sm:leading-[70px] md:leading-[110px]   text-[#0F2E3C] max-w-[171px ] md:max-w-[680px]">
          ...
          <div className="home-hero-img w-full md:w-[52%] mt-[-30px] right-0 md:right-[-20px] before:w-[58px] md:before:w-[160px] relative before:h-[58px] md:before:h-[160px] before:bg-[#AE8B5C] before:rounded-[100px] before:right-[0] md:before:right-[-25px] before:bottom-0 md:before:bottom-[20px] before:absolute p-[2%]">
            <Image src={heroimg} />
          </div>
        </div>
      </section>
