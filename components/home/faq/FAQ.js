const FAQ = () => {
    ...
    return (
        <section id='faq' className="bg-[#fff] pt-0 md:pt-[50px] pb-[40px] md:pb-[70px] px-[20px] md:px-[50px]">
            <div className="myContainer">
                ...
                <div id="accordion-collapse" className="mt-0 md:mt-[70px]">
                    <h2 id="accordion-collapse-heading-1" className="all-coll-heading" onClick={()=>toggle("1")}>
                        <button type="button" className="flex items-center justify-between w-full py-0 px-[5px] md:p-3.5 font-medium text-left border-b-[1px] border-0 md:border-b-[1px] border-[#292929] focus:outline-none" >
                        <span className="fgr text-[12px] md:text-[18px] leading-[12px] md:leading-[20px] text-[#292929]">What is Coaching?</span>
                    ...
                    <h2 id="accordion-collapse-heading-2" className="all-coll-heading" onClick={()=>toggle("2")}>
                        <button type="button" className="flex items-center justify-between w-full py-0 px-[5px] md:p-3.5 font-medium text-left text-gray-500 border-b-[1px] border-0 md:border-b-[1px] border-[#292929] focus:outline-none" >
                        <span className="fgr text-[12px] md:text-[18px] leading-[12px] md:leading-[20px] text-[#292929]">What makes Ihsan Coaching different</span>
                    ...
                    <h2 id="accordion-collapse-heading-3" className="all-coll-heading" onClick={()=>toggle("3")}>
                        <button type="button" className="flex items-center justify-between w-full py-0 px-[5px] md:p-3.5 font-medium text-left text-gray-500 border-b-[1px] border-0 md:border-b-[1px] border-[#292929] focus:outline-none" >
                        <span className="fgr text-[12px] md:text-[18px] leading-[12px] md:leading-[20px] text-[#292929]">How much does each coaching session cost?</span>
                        <svg data-accordion-icon="" className="w-[18px] md:w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                        </button>
                    </h2>
                    ...
                    <h2 id="accordion-collapse-heading-4" className="all-coll-heading" onClick={()=>toggle("4")}>
                        <button type="button" className="flex items-center justify-between w-full py-0 px-[5px] md:p-3.5 font-medium text-left text-gray-500 border-b-[1px] border-0 md:border-b-[1px] border-[#292929] focus:outline-none" >
                        <span className="fgr text-[12px] md:text-[18px] leading-[12px] md:leading-[20px] text-[#292929]">Do you take insurance?</span>
                        <svg data-accordion-icon="" className="w-[18px] md:w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                        </button>
                    </h2>
                    ...
                    <h2 id="accordion-collapse-heading-5" className="all-coll-heading" onClick={()=>toggle("5")}>
                        <button type="button" className="flex items-center justify-between w-full py-0 px-[5px] md:p-3.5 font-medium text-left text-gray-500 border-0 md:border-0 border-[#292929] focus:outline-none" >
                        <span className="fgr text-[12px] md:text-[18px] leading-[12px] md:leading-[20px] text-[#292929]">How does booking with Ihsan Coaching work?</span>
                        <svg data-accordion-icon="" className="w-[18px] md:w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                        </button>
                    </h2>
