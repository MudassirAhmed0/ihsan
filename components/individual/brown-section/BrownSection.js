  ...
  return (
    <section className="text-[#fff] pt-[60px] md:pt-[120px] pb-[70px] md:pb-[140px] relative overflow-hidden">
      ...
      <div className="myContainer relative z-[2]">
        <h1 className='fpr text-[35px] md:text-[60px] sc1500:text-[70px] leading-[35px] md:leading-[60px] sc1500:leading-[85px] text-center max-w-[900px] mx-auto'>Areas our individual coaching can help you with</h1>
        ...
        <ul className='flex flex-wrap max-w-[900px] mx-auto gap-y-[10px] md:gap-y-[30px] pt-[5%] md:pt-[3%] list-square'>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[26px] md:leading-[36px] text-[#fff] ml-[5%] md:ml-0 w-[90%] md:w-[50%]">Anxiety Management</li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[26px] md:leading-[36px] text-[#fff] ml-[5%] md:ml-0 w-[90%] md:w-[50%]">Post-Devorce Coaching</li>
