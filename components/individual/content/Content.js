    ...
    <section className={`w-full pt-[40px] md:pt-[60px] lg:pt-[100px] pb-[30px] md:pb-[70px] bg-[#fff] relativ e ${pb ? "pb-[300px]" : ""}`}>
      ...
      <div className="myContainer flex flex-col xl:flex-row justify-end relative pt-[3.7%] pb-[8%]">
        ...
        <div className="w-full xl:w-[50%] pt-[97%] md:pt-[680px] xl:pt-0">
          ...
          <h6 className="fgb text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] py-[35px]">
            You may need an individual coach if you’re…
          </h6>

          <ul className='flex flex-wrap list-disc'>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling lost and confused</li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Not sure what to do in life</li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Having relationship issues</li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling a career change, but have doubts</li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling anxious</li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling stress, and lacking self confidence</li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Full of anger</li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling a change, but need guidance</li>
            <li className="fgr text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling lonely</li>
          </ul>
        </div>
      </div>
    </section>
