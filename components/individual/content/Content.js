      ...
      <div className="myContainer flex flex-col lg:flex-row justify-end relative pt-[3.7%] pb-[8%]">
        ...
        <div className="w-full xl:w-[50%] pt-[92%] sm:pt-[86%] md:pt-[680px] xl:pt-0">
          ...
          <ul className='flex flex-wrap list-disc'>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling lost and confused</li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Not sure what to do in life</li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Having relationship issues</li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling a career change, but have doubts</li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling anxious</li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling stress, and lacking self confidence</li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Full of anger</li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling a change, but need guidance</li>
            <li className="fgr text-[12px] md:text-[16px] leading-[16px] md:leading-[26px] text-[#555555] ml-[5%] sm:ml-0 w-[90%] sm:w-[50%]">Feeling lonely</li>
          </ul>
        </div>
      </div>
    </section>
